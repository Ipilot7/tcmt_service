...
router.register(r'statuses', core_viewsets.StatusViewSet)
...
router.register(r'task-statuses', tasks_viewsets.TaskStatusViewSet)
router.register(r'task-responsibles', tasks_viewsets.TaskResponsibleViewSet)
router.register(r'trips', trips_viewsets.TripViewSet)
router.register(r'trip-statuses', trips_viewsets.TripStatusViewSet)
router.register(r'trip-results', trips_viewsets.TripResultViewSet)
router.register(r'trip-users', trips_viewsets.TripUserViewSet)
